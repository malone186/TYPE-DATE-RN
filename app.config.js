...
function validateProductionConfig() {
  ...
  if (!/^ca-app-pub-\d{16}~\d{10}$/.test(process.env.ADMOB_ANDROID_APP_ID)) {
  ...
  if (
    ...
    process.env.EXPO_PUBLIC_ADMOB_INTERSTITIAL_ANDROID_ID === 'ca-app-pub-3940256099942544/1033173712'
  ) {
